(function ($) {
    ...
    $.fn.miniEventCalendar = $.fn.MEC = function (options) {
        ...
        ////show event with calling ajax and popup a model to show items
        //mini_cal.on("click, focusin", ".a-date", function () {
        //    if (!$(this).hasClass('blurred'))
        //        var char = $("#monthYear").text().split(" ");
        //    var date = $(this).text() + "-" + char[0] + "-" + char[1];
        //    $.ajax({
        //        type: "POST",
        //        url: '/WeeklyMenu/GetMenuByDate',
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(response).each(function () {
                        ...
                        $("#menuTbody").append('<tr><td>' + this.menuName + '</td><td>'+item+'</td></tr>');
